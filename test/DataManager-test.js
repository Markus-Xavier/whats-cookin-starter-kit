...
describe('DataManager', function() {
  let dataManager, recipeTags, userInput, userInput2, userInput3, filteredResultsByTag, filteredResultsByKeywords, filteredResultsByTagsAndKeywords;
  ...
  it('should return a list of recipes filtered by tags and keywords', function () {
    dataManager.setRecipes(filteredResultsByTagsAndKeywords);
   dataManager.filterRecipes(userInput);

    assert.deepEqual(dataManager.filteredRecipes, filteredResultsByTagsAndKeywords)
  })

  it.skip('should return a list of recipes filtered by keywords', function () {
    dataManager.filterRecipes();

    assert.deepEqual(dataManager.filterRecipes(userInput2), filteredResultsByKeywords)
  })
